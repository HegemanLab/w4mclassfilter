...
, order_smpl = "sampleMetadata"
  ...
  variableMetadata_out <- "output_sort_variableMetadata.tsv"
  variableMetadata_exp <- "expected_sort_variableMetadata.tsv"
  sampleMetadata_in <- "input_sampleMetadata.tsv"
  sampleMetadata_out <- "output_sort_sampleMetadata.tsv"
  sampleMetadata_exp <- "expected_sort_sampleMetadata.tsv"
  dataMatrix_in <- "input_dataMatrix.tsv"
  dataMatrix_out <- "output_sort_dataMatrix.tsv"
  dataMatrix_exp <- "expected_sort_dataMatrix.tsv"
  # test input files
...
#' @export
test_that("sort test 2.1 - regex_include_all", {
  run_sort_test(
