...
- `d_dot` ($D^{\circ}$ or $D^{\bullet}$), which indicates the spread of the replicates for the treatment relative to the spread between the treatments (analogous to D--ratio).
...
## Options for output (planned for future)
