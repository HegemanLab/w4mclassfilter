...
* Features may also be eliminated by specifying ranges of values allowable in columns of `variableMetadata`.
...
structures (data.frame, matrix, list, env); see 'New in release v0.98.3' below.
